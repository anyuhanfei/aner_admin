...
-- ----------------------------
INSERT INTO `adm_admin` VALUES ('1', 'root', '42960a50f11334ea5bcba697e67bc7b0', 'BJPrExO9', '/uploads\\admin_via\\20190827\\6f8bcfe528d7c2a990255cf253f379dd.jpg', '暗语寒飞', '4', '13939390001', '1223050252@qq.com', '1223050251', 'anyuhanfeifff');
...
-- ----------------------------
INSERT INTO `cms_article` VALUES ('14', ',1,', '1', '测试', '暗语寒飞', '                                                                                                                                                                                                        ', '唉唉唉', '/uploads\\article\\20190823\\4d6861e73045b74ca9be0c33736ca40e.png', '1', 'markdown', '                                                                                                                                                                        $(\"#content_show\").html(marked($(\"#content_write\").val()));                                ');
...
CREATE TABLE `cms_article_data` (
  ...
  `is_stick` tinyint(1) NOT NULL COMMENT '置顶',
  `is_hot` tinyint(1) NOT NULL COMMENT '热门',
  `is_recomment` tinyint(1) NOT NULL COMMENT '推荐',
...
-- ----------------------------
INSERT INTO `idx_user_fund` VALUES ('2', '171.00', '0.00');
INSERT INTO `idx_user_fund` VALUES ('5', '0.00', '0.00');
INSERT INTO `idx_user_fund` VALUES ('6', '0.00', '0.00');
INSERT INTO `idx_user_fund` VALUES ('7', '0.00', '0.00');
INSERT INTO `idx_user_fund` VALUES ('8', '0.00', '0.00');
INSERT INTO `idx_user_fund` VALUES ('9', '0.00', '0.00');
