...
-- ----------------------------
-- Table structure for `log_idx_user_fund`
-- ----------------------------
DROP TABLE IF EXISTS `log_idx_user_fund`;
CREATE TABLE `log_idx_user_fund` (
...
INSERT INTO `sys_catalog` VALUES ('35', '资金流水', 'la la-credit-card', '14', '115', 'log/index_user_fund_log', '/admin/index/user/fund/log', '30', '117');
...
INSERT INTO `sys_module_action` VALUES ('115', '14', '资金流水', 'log/index_user_fund_log', '/admin/index/user/fund/log', '104', '');
